...
function App() {
 ...
 const [projects] = useState([
   ...
   },
   {
    ...
    tech: ["Django", "Python", "postgreSQL", "Materialize CSS", "Bootstrap CSS", "AWS"],
  ...
  {
    title: "Thriftd", 
    headline: "Depop/Shopify-style peer-to-peer shopping application built with", 
  ...
  },
  {
    ...
    headline: "Browser-based trivia game with a Western Classical Music theme built with", 
