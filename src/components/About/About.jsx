  ...
  return (
    <div class="about-me">
      ...
      <p class="bio">
        ...
        <br/>
          <br/>
          Always curious about the web, I started my journey by managing and customizing Wordpress websites. I later enrolled in 
         ...
         I have a well-known, unhealthy addiction to cult movies and the 80's. 
      </p>
    </div>
  );
};
