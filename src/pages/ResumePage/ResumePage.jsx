  ...
  render() {
    return (
        ...
        <a
              ...
              aria-label="Mail"
            >
              <BsFillEnvelopeFill id="envelope" class='icon' style={{ fontSize: '25px' }}/>
            </a>
            </div>
        <br/>
        <br/>
        ...
        <br />
        <p class='text level'>Level 10 Piano Performance (current ARCT candidate)</p>
        ...
        <p class='text'>Toronto | 2004-2006</p><br/>
...
<p class='text'>Piano performance and music theory instructor. One-on-one music teacher to kids as young as 4, teens and adults. Other duties included schedule coordination, examinations and administration.</p>
<br/>
<p class="job text">Real Estate Sales Representative</p>
<p class="job-italic text">Sutton Group Realty Systems/Bosley Real Estate, <span class="job-place-date"> Toronto, 2010 - 2021</span></p><br/>
<p class='text'>Worked as a downtown Toronto condo specialist helping clients buy, sell lease, and home stage condominiums, as well as managed tenanted properties for investors. Additionally was engaged in home staging and reno/home prep. </p>
<br/>
<p class="job text">Fashion Showroom Assistant</p>
<p class="job-italic text">OK-47, <span class="job-place-date text">Toronto, 2005 - 2006</span></p> <br/> 
...
<p class="job-italic text">Lounge, <span class="job-place-date text"> Toronto |  2004 - 2005 </span></p><br/>
...
<br/>
<br/>
<footer id="footer" class='text'>Copyright Tatyana Karlen 2022</footer>
<br/>
<br/>
